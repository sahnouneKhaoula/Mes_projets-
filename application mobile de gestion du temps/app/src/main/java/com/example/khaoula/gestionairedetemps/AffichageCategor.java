...
/**
 * Created by youcef on 14/05/2018.
 */

public class AffichageCategor  extends Activity {
    ListView affichage ;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(intent!=null){
            if(intent.hasExtra("categ")){
                a=intent.getStringExtra("categ");
            }
    ...
    public void afficherliste ()
    {
        ...
        ArrayList aff=bd_sql.affichec(a);
        if (aff.isEmpty()) Toast.makeText(AffichageCategor.this, " pas d'evenement "+a, Toast.LENGTH_SHORT).show();
        else {
            ...
            affichage.setOnItemClickListener(new AdapterView.OnItemClickListener() {
              ...
              String date=a.substring(h1,h).trim();
               ...
               if(catego.equals("prise de medicament")){
                    Intent intent = new Intent(AffichageCategor.this,affiche2.class);
                   ...
                   Intent intent = new Intent(AffichageCategor.this, ShopingA.class);
                   Bundle bundle = new Bundle();
                   bundle.putString("affic",affic);
                   bundle.putString("datec",date);
                   bundle.putString("heurc",heur);
                   ...
                   Intent intent = new Intent(AffichageCategor.this, AfficheListe.class);
                   Bundle bundle = new Bundle();
                   bundle.putString("affic",a);
                   bundle.putString("datec",date);
                   bundle.putString("heurc",heur);
                   intent.putExtras(bundle);
                   startActivity(intent);}
    ...
    public void main(View view){
        Intent intent=new Intent(AffichageCategor.this,MainActivity.class);
        startActivity(intent);
    }
    public void retour(View view)
    { AffichageCategor.this.finish();}
}
